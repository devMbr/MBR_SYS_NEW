...
namespace MBR.Web
{
    ...
    public class StringUtil
    {
        ...
        /// <param name="origin"></param>
        /// <returns></returns>
        public static string DelFirstComma(string origin)
        {
            if (origin.IndexOf(",") == -1)
            {
                return origin;
        ...
        /// <returns></returns>
        public static string Null2Blank(object o, string defaultString)
        {
            if (o == null)
        ...
        public static string Join2String(IEnumerable<string> stringList, string join)
        {
            ...
            if (res.StartsWith(join)) res = res.Substring(join.Length);
            return res;
        }
        public static string Join2String(IEnumerable<int> stringList, string join)
        {
            if (stringList == null) return string.Empty;
            string res = string.Empty;
            foreach (var item in stringList)
